...
def create_experience(current_user):
    """Create experience baru (Admin Only) - Fleksibel Form & JSON"""
    try:
        # PENGAMANAN: Cek apakah inputan berbentuk JSON atau Form HTML
        if request.is_json:
        ...
        values = (
            ...
            data.get('perusahaan'),
            data.get('durasi'),
            data.get('deskripsi', '') # Default string kosong jika deskripsi dikosongkan
        )
