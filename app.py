...
# Import blueprints dari folder Backend Anda
...
def create_app():
    # Ambil jalur folder absolut tempat file app.py ini berada
    ...
    # Register blueprints ke sistem Flask
    ...
    # Mendukung pengetikan rute dengan /Frontend/ atau langsung /admin/ menggunakan jalur absolut Windows
    ...
    def profil_pages(filename):
        return send_from_directory(os.path.join(base_dir, 'Frontend', 'profil'), filename)

    # Menangani otomatis prapemuaian favicon.ico
